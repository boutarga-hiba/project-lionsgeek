...
Modifiez le studio  </button>

  <!-- Modal -->
  <div class="modal fade" id="{{$studio->id}}" tabindex="-1" aria-labelledby="{{$studio->id}}Label" aria-hidden="true">
        ...
        <div class="modal-body">
          <form action={{route("studio.update",$studio->id)}} method="POST">
            ...
            <div>
                ...
                <input type="text" name="description" id="description" value="{{old("description",$studio->description)}}" required>
            </div>
        </div>
